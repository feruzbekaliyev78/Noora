export const translations = {
  ru: {
    ...
    lightGood: 'Свет отличный',
    lightBad: 'Темновато',
    lightBright: 'Слишком ярко',
    lookGood: 'Хорошо',
    lookBad: 'Смотри в камеру',
    faceNotFound: 'Лицо не видно',
    foreheadGood: 'Лоб открыт',
    foreheadBad: 'Убери волосы со лба',
    makeupGood: 'Без макияжа',
    makeupBad: 'Сними макияж',
  ...
  uz: {
    ...
    scanning: 'Skanerlash',
    lightGood: 'Yorug\'lik a\'lo',
    lightBad: 'Qorong\'i',
    lightBright: 'Juda yorug\'',
    lookGood: 'Yaxshi',
    lookBad: 'Kameraga qarang',
    faceNotFound: 'Yuz ko\'rinmayapti',
    foreheadGood: 'Peshon ochiq',
    foreheadBad: 'Sochlarni peshondan olib tashlang',
    makeupGood: 'Makiyajsiz',
    makeupBad: 'Makiyajni yuvib oling',
