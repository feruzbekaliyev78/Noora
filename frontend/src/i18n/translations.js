export const translations = {
  ...
  uz: {
    ...
    scanning: 'Skanerlash',
    lightGood: 'Yaxshi yorug\'lik',
    lightBad: 'Qorong\'i',
    lightBright: 'Juda yorug\'',
    lookGood: 'Yaxshi',
    lookBad: 'Kameraga qarang',
    faceNotFound: 'Yuz topilmadi',
    camFaceOk: 'Kameraga qarang',
    foreheadGood: 'Peshona ochiq',
    foreheadBad: 'Sochni olib tur',
    makeupGood: 'Makiyajsiz',
    makeupBad: 'Makiyaj bor',
